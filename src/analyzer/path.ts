/**
 * Analyzer Path Utilities
 *
 * Self-contained path normalization owned by the analysis core (mirrors
 * src/foundation/utils/path.ts). Only the canonicalization helpers the
 * analyzer uses are included; node:path-based helpers are not.
 */
